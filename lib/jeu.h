...
public:
    ...
    //ajout
    int menuJeuParabole(std::ostream& sout, std::istream& sin);
    int menuParabole(std::ostream& sout, std::istream& sin, Joueur* joueur, Joueur* adversaire);
